      ...
      <asp:PostBackTrigger ControlID="Grilla_Cliente" /> 
                    ...
                    <div class=" col-12" style="background-color:#727272">
                        <div class="div_titilo_crear_cliente">
                            <div class="TitleForm">
                                ...
                                <asp:Label ID="Txt_Titulo_Habilitados" runat="server" Text="Lista de clientes habilitados" Font-Size="Large" ForeColor="White"></asp:Label>
                                <asp:Label ID="Txt_Titulo_Eliminados" runat="server" Text="Lista de clientes eliminados" Font-Size="Large" Visible="False" ForeColor="White"></asp:Label>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row" style="margin: 10px;">
                    <div class="col" style="text-align:center;">
                        <asp:Button Text="Agregar cliente" class="btn-agregarempresa" runat="server" ID="btn_agregar_cliente" OnClick="btn_agregar_cliente_Click"  Style="padding: 5px; font-size: 12px;" Font-Size="Smaller" />
                        <asp:Button Text="ver deshabilitados" class="btn-verdeshabilitados" runat="server" ID="Btn_ver_deshabilitados" Style="padding: 5px; font-size: 12px;" OnClick="Btn_ver_eliminados_Click" Visible="False" Font-Size="Smaller" />
                        <asp:Button Text="ver habilitados" class="btn-verhabilitados" runat="server" ID="Btn_ver_habilitados" Style="padding: 5px; font-size: 12px;" OnClick="Btn_ver_habilitados_Click" Visible="False" Font-Size="Smaller" />
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">

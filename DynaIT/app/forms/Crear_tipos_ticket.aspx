...
<body>
    <form id="form1" runat="server">
      ...
      <asp:PostBackTrigger ControlID="Grilla_Tipos_Ticket" /> 
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="row" style=" background-color:#727272;">
                            <div class="col-12" style=" text-align: center">
                                <div class="div_titilo_crear_cliente" style="text-align: center;">
                                    <asp:Label ID="Lbl_Titulo_Todos_Creados" runat="server" Text="Tipos de tickets Creados" Font-Bold="True" Font-Size="Large" ForeColor="White"></asp:Label>
                                    <asp:Label ID="Lbl_Titulo_Eliminados" runat="server" Text="Tipos de tickets Eliminados" Visible="False" Font-Bold="True" Font-Size="Large" ForeColor="White"></asp:Label>
                                </div>
                            </div>
                        </div>
                        <div class="row" style="margin:20px;">
                            <div class="col-12">
                                <div style="margin: auto; text-align: center;">
                                    ...
                                    <asp:Button Text="Agregar grupo" class="btn-agregarempresa" runat="server" ID="btn_agregar_grupo" Style="padding: 5px; " OnClick="btn_agregar_grupo_Click" />
                                    <asp:Button Text="ver deshabilitados" class="btn-verdeshabilitados" runat="server" ID="Btn_ver_deshabilitados" Style="padding: 5px; "  Visible="False" OnClick="Btn_ver_deshabilitados_Click" />
                                     <asp:Button Text="ver habilitados" class="btn-verhabilitados" runat="server" ID="Btn_ver_habilitados" Style="padding: 5px; "  Visible="False" OnClick="Btn_ver_habilitados_Click" />
                                        ...
                                        <div class="GrillaInferior" style="width: 100%; text-align:center; justify-content: center; display: flex;">
                                            <div class="table-responsive" style="width:70%">
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:ButtonField CommandName="Select" Text="Editar"  ControlStyle-ForeColor="#000" FooterStyle-ForeColor="#000" >
                                                ...
                                                <HeaderStyle BackColor="#424C52" BorderStyle="None" Font-Bold="True" Font-Italic="True" ForeColor="White" HorizontalAlign="Center" VerticalAlign="Middle" />
                                                <PagerStyle BackColor="#3399FF" ForeColor="White" HorizontalAlign="Center" />
                                                <RowStyle BackColor="#EFF3FB" BorderStyle="None" />
                                                <SelectedRowStyle BackColor="#000"  ForeColor="#000" />

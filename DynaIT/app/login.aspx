    ...
    <div class="wrapper fadeInDown">
        <div id="formContent" >
            ...
            <div class="fadeIn first" style="margin: 20px;">
                <img src="img/dynamics.png" class="" id="icon" alt="User Icon" style="max-width:70%; max-height:70%;" />
            </div>
            ...
            <!-- Remind Passowrd -->
            <div id="" style="padding-bottom:15px;"> 

                <a class="underlineHover" href="forms/Recuperar_Contraseña.aspx" style="color:#000">¿Olvido su contraseña?</a>
            </div>
